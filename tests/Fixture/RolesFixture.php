...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'roles_shifted_from' => ['type' => 'index', 'columns' => ['shifted_from'], 'length' => []],
            'roles_shifted_to' => ['type' => 'index', 'columns' => ['shifted_to'], 'length' => []],
            'roles_user' => ['type' => 'index', 'columns' => ['user'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'roles_shifted_from' => ['type' => 'foreign', 'columns' => ['shifted_from'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'roles_shifted_to' => ['type' => 'foreign', 'columns' => ['shifted_to'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'roles_user' => ['type' => 'foreign', 'columns' => ['user'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
