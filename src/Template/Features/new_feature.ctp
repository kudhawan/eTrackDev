	<body class="dashboard-bg"> 
	    <div id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<!-- //////// Content Part START ///////// -->
				<div class="col-lg-12">
					<div class="page-heading"><h1><span class="fa fa-bullhorn"></span> New Feature of <?php echo ucwords($projectDetail->name); ?></h1></div>
				</div>
				<form method="POST" id="newProject" action="<?php echo HTTP_ROOT.'Features/newFeature.json' ?>" enctype="multipart/form-data">
					<div class="col-lg-12">
...
<div class="ui-form">
							...
							<div class="optional-button top-margin clearfix">
								<div class="right-buttons">
									...
									<a class="btn corner grey" href="<?php echo HTTP_ROOT.'feature-list/'.$id ?>">
