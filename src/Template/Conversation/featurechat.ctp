	<body class="dashboard-bg">    
	    <div id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<!-- //////// Content Part START ///////// -->
					<div class="col-lg-12">
						<div class="page-heading"><h1><span class="fa fa-comment"></span> Conversation</h1></div>
					</div>
						...
						<div class="box-dashboard custom-chat">
							...
							<div class="post">
								<div class="user-block">
									...
									<h2 class="detail-title">Feature Detail</h2>
									<span class="username">
										<label>Feature</label>
								...
								<div class="comment-outer">
									...
									<form class="form-horizontal form-chat" method="post" id="conversationForm"name="chat-form" action="<?php echo HTTP_ROOT.'conversation.json?feature_id='.base64_encode(convert_uuencode($getProject->id)) ?>">
