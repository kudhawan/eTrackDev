						...
						<div class="box-dashboard custom-chat">
							...
							<div class="post">
								...
								<div class="comment-outer">
									...
									<?php if(isset($getProject->name) && $getProject->name){?>
									<form class="form-horizontal form-chat" method="post" id="conversationForm"name="chat-form" action="<?php echo HTTP_ROOT.'conversation.json?project_id='.base64_encode(convert_uuencode($getProject->id)) ?>">
									<?php } else {?>
